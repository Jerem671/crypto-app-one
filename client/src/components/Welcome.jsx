    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-left text-white mt-5 font-light md:9/12 w-11/12 text-base">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#254cbd]"
            >
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div
              className={`rounded-tr-none sm:rounded-tr-2xl ${commonStyles}`}
            >
              Ethereum
            </div>
